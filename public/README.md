...
キャリア序盤、転職を繰り返した時期がありました。当時は環境に原因を求めていましたが、振り返ると根本には「自分への期待値の高さ」がありました。現実とのギャップを自己否定に変え、環境を変えることで解消しようとしていたと今は認識しています。

この自己理解に至ったことで、目標設定と振り返りをしながら、自分と向き合って仕事に向き合うように心がけています。
```
